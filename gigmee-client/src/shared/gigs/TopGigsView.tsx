    ...
    <div className="mx-auto my-8 flex flex-col overflow-hidden rounded-lg">
        ...
        <div className="flex items-start py-6">
          <div className="flex w-full flex-col justify-between">
            <div className="flex gap-2">
              ...
              {category && (
                <span className="flex self-center text-base font-bold cursor-pointer text-green-500 md:text-lg lg:text-2xl hover:text-green-400 hover:underline">
                  <Link
                    onClick={() => {
      ...
      <div className="m-auto flex h-96 w-full overflow-x-auto" ref={navElement}>
        {scroll.start && gigs.length > 5 && (
          <span
            onClick={slideLeft}
            className="absolute left-2 z-50 flex cursor-pointer justify-start self-center rounded-full bg-green-400 sm:left-3 md:left-7 lg:left-0"
          >
        ...
        {!scroll.end && gigs.length > 5 && (
          <span
            onClick={slideRight}
            className="absolute right-2 flex max-w-4xl cursor-pointer justify-end self-center rounded-full bg-green-400 sm:right-3 md:right-7 lg:right-0"
          >

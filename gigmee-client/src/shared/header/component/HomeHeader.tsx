                  ...
                  >
                    <Button
                      ...
                      label={
                        <>
                          {openSidebar ? (
                            <FaTimes className="h-6 w-6 text-green-500" />
                          ) : (
                            <FaBars className="h-6 w-6 text-green-500" />
                          )}
                        </>
                      }
                    />
                    ...
                    {buyer && !buyer.isSeller && (
                      <li className="relative flex items-center">
                        <Link
                          ...
                          className="relative ml-auto flex h-9 items-center justify-center rounded-full bg-green-500 text-white font-bold sm:px-6 hover:bg-green-400"
                        >
              ...
              <div className="justify-left md:justify-left container mx-auto flex px-6 lg:justify-center">
                ...
                >
                  {categories().map((category: string) => (
                    <span
                      key={uuidv4()}
                      className="mx-4 cursor-pointer first:ml-0 hover:text-green-400 lg:mx-0"
                    >
                      <Link

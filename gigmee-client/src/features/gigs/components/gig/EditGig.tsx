...
import { useUpdateGigMutation } from "src/features/gigs/service/gigs.service";
...
const EditGig: FC = (): ReactElement => {
  ...
  const isNotWorking: boolean = true;
      ...
      {isNotWorking ? (
        <div className="flex items-center justify-center w-screen h-screen">
          <div className="text-center">
            ...
            <Button
              className="rounded bg-green-500 mt-4 px-8 py-2 text-center text-sm font-bold text-white hover:bg-green-400 focus:outline-none md:py-3 md:text-base"
              label="Go back"
              onClick={() => {
        ...
        <>
          {showGigModal.cancel && (
            <ApprovalModal
              ...
              onClose={() =>
                setShowGigModal({ ...showGigModal, cancel: false })
              }
          ...
          <div className="relative w-screen">
            <BreadCrump breadCrumbItems={["Seller", "Edit gig"]} />

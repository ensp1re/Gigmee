...
import { useVerifyEmailMutation } from 'src/features/auth/service/auth.service';
...
const ConfirmEmail: FC = (): ReactElement => {
  ...
  return (
    <div className="container mx-auto flex flex-col items-center justify-center px-6 py-8 mt-20 lg:py-0">
      ...
      <Link
        to="/"
        className="rounded bg-green-500 px-6 py-3 mt-5 text-center text-sm font-bold text-white hover:bg-green-400 focus:outline-none md:px-4 md:py-2 md:text-base"
      >
        Continue to Home
      </Link>
    </div>

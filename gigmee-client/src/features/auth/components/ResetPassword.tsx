...
import { useResetPasswordMutation } from "src/features/auth/service/auth.service";
import { resetPasswordSchema } from "src/features/auth/schemes/auth.scheme";
import Header from "src/shared/header/component/Header";
        ...
        <div className="relative px-5 py-5">
          ...
          <form className="mt-4 space-y-4 md:space-y-5 lg:mt-5">
            ...
            <Button
              ...
              className={`text-md flex justify-center mt-5 w-full cursor-pointer rounded bg-green-500 px-8 py-2 text-center  font-bold text-white hover:bg-green-400 focus:outline-none ${!userInfo.password || !userInfo.confirmPassword ? "cursor-not-allowed" : "cursor-pointer"}`}
              label={

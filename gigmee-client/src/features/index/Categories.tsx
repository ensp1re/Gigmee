    ...
    <section className="container mx-auto bg-white">
      <div className="mx-auto px-4 py-8 text-center lg:px-6 lg:py-10">
        <div className="mx-auto mb-2 lg:mb-16">
          <h2 className="mb-4 text-left sm:text-center text-xl lg:text-2xl font-normal tracking-tight text-emerald-300">
            ...
            return (
              <div key={uuidv4()} className="w-full py-5 cursor-pointer">
                <img
                  ...
                  alt={category.name}
                />
                <h3 className="mb-1 text-base hover:text-emerald-300">

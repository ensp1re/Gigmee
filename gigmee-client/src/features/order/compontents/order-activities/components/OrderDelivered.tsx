...
import { FaCheck, FaChevronDown, FaChevronUp, FaDownload, FaGift } from 'react-icons/fa';import ChatBox from 'src/features/chat/components/ChatBox/ChatBox';
                              ...
                              <div className="w-full text-sm dark:text-white">
                                ...
                                <div className="flex flex-col justify-between text-[#777d74]">
                                  ...
                                  <div className="mt-3 flex flex-col">
                                    ...
                                    >
                                      <div className="absolute h-full rounded-l border-l-8 border-[#4af377]"></div>
                            ...
                            <div className="w-full text-sm dark:text-white">
                              <div className="flex flex-col justify-between text-[#777d74]">
                                <span className="text-sm md:text-[15px]">
                                  ...
                                  <a onClick={() => setShowChatBox(!showChatBox)} className="px-1 text-green-500 hover:underline" href="#">
                                    Go to Inbox
                                  </a>

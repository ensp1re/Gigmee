            ...
            <div className="mt-4 flex flex-col justify-between bg-white md:flex-row">
              ...
              <div className="mb-4 ml-5 w-full justify-center self-center text-left md:mr-3 md:w-1/3 md:text-right">
                {order && order.delivered && order.buyerUsername === authUser.username && (
                  <Button
                    className="rounded bg-green-500 px-2 py-2 text-center text-sm font-bold text-white hover:bg-green-400 focus:outline-none md:px-4 md:py-2 md:text-base"
                    label="View Delivery"
                    onClick={() => {
              ...
              <div className="bg-white">
                <div className="mb-2 flex flex-col border-b px-4 pb-4 pt-3 md:flex-row">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span
                      className={`status mt-1 w-24 rounded px-[3px] py-[3px] text-xs bg- font-bold uppercase text-white md:ml-4 ${order.status.replace(
                        / /g,
                        ''
                      )}`}
                    >

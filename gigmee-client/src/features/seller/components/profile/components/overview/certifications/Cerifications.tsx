...
import { FaPencilAlt } from 'react-icons/fa';import { SellerContext } from 'src/features/seller/context/SellerContext';
import { ICertificate } from 'src/features/seller/interfaces/seller.interface';
import { v4 as uuidv4 } from 'uuid';
import CertificateEditFields from './CertificationsEditFields';
      ...
      <div className="mb-1 flex justify-between border-b">
        ...
        {showEditIcons && (
          <span
            ...
            className="flex cursor-pointer items-center pr-3.5 text-sm text-[#31b347] md:text-base"
          >
            Add New
          </span>
        )}

            ...
            <div className="flex cursor-pointer self-center md:block md:self-start">
              ...
              {showItemEdit.fullname && (
                <div className="flex gap-x-4">
                  <TextInput
                    className="mt-2 flex h-7 w-full items-center rounded border border-gray-300 p-1.5 text-sm font-normal text-gray-600 focus:border focus:border-green-500/50 focus:outline-none lg:h-9"
                  ...
                  <div className="my-2 flex">
                    <Button
                      className="md:text-md rounded bg-green-500 px-6 py-1 text-center text-sm font-bold text-white hover:bg-green-400 focus:outline-none md:py-2"
                      label="Update"
                      onClick={() => {

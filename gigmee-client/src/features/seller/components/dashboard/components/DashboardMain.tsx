                ...
                {seller?.ratingSum && seller?.ratingsCount ? (
                  <div className="flex w-full justify-center gap-x-1 self-center">
                    <div className="mt-1 w-20 gap-x-2">
                      <Rating value={rating(seller?.ratingSum / seller?.ratingsCount)} size={14} />
                    </div>
          ...
          <ul className="flex w-full cursor-pointer list-none flex-col px-6 md:flex-row">
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm ${
                type === 'active' ? 'text-green-500 md:border-b-2 md:border-green-500' : ''
              }`}
            >
              ACTIVE GIGS
            </li>
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm ${
                type === 'paused' ? 'text-green-500 md:border-b-2 md:border-green-500' : ''
              }`}
            >
              PAUSED
            </li>
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm ${
                type === 'orders' ? 'text-green-500 md:border-b-2 md:border-green-500' : ''
              }`}
            >
              ACTIVE ORDERS
            </li>

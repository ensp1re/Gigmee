import { ChangeEvent, FC, ReactElement } from 'react';import { ISocialLinksProps } from 'src/features/seller/interfaces/seller.interface';
      ...
      <div className="flex w-full flex-col px-6 pb-3 pt-6">
        <div className="flex justify-between">
          ...
          <Button
            ...
            className="md:text-md h-7 rounded bg-green-500 px-6 text-center text-sm font-bold text-white hover:bg-sky-400 focus:outline-none md:px-8"
            label="Add More"
          />
        </div>

...
import { BadRequestError, IAuthDocument, firstLetterUppercase, lowerCase } from '@ensp1re/gigme-shared';
...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  for(let i = 0; i < usernames.length; i++) {
    ...
    const authData: IAuthDocument = {
      ...
      browserName: faker.internet.protocol(),
      deviceType: faker.internet.userAgent()
    } as IAuthDocument;
